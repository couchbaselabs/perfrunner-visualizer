...
function drawCharts(network, memory, latency, gateload) {
    d3.json(seriesUrlBase + "_all_dbs",
            function(data) {
                if (data) {
                    drawGateloadCharts(gateload, ["gateload_1","gateload_2","gateload_3"]);                    
                    drawNetworkCharts(network, ["gateway_1","gateway_2","gateway_3"]);
                    drawMemoryCharts(memory, ["gateway_1","gateway_2",,"gateway_3","gateload_1","gateload_2","gateload_3"]);
