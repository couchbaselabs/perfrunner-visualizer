var seriesUrlBase = "http://172.23.106.228:3133/";
...
function drawCharts(network, memory, latency, gateload) {
    d3.json(seriesUrlBase + "_all_dbs",
            function(data) {
                if (data) {
                    drawGateloadCharts(gateload, ["gateload_1","gateload_2","gateload_3","gateload_4"]);                    
                    drawNetworkCharts(network, ["gateway_1","gateway_2","gateway_3","gateway_4"]);
                    drawMemoryCharts(memory, ["gateway_1","gateway_2",,"gateway_3","gateway_4","gateload_1","gateload_2","gateload_3","gateload_4"]);
...
function drawNetworkCharts(here, nodes) {
    ...
    var sets = [
        ...
        {p: "/cb/pools/172.23.96.62:11210/count", red: "c_avg", "lbl": "172.23.96.62:11210 pool count", cls: "count"},
        {p: "/cb/pools/172.23.96.62:11210/max", red: "avg", "lbl": "172.23.96.62:11210 pool max", cls: "max"},
        {p: "/cb/pools/172.23.96.62:11210/mean", red: "avg", "lbl": "172.23.96.62:11210 pool mean", cls: "mean"},
        {p: "/cb/pools/172.23.96.62:11210/p99", red: "avg", "lbl": "172.23.96.62:11210 pool p99", cls: "p99"},

        {p: "/cb/pools/172.23.96.67:11210/count", red: "c_avg", "lbl": "172.23.96.67:11210 pool count", cls: "count"},
        {p: "/cb/pools/172.23.96.67:11210/max", red: "avg", "lbl": "172.23.96.67:11210 pool max", cls: "max"},
        {p: "/cb/pools/172.23.96.67:11210/mean", red: "avg", "lbl": "172.23.96.67:11210 pool mean", cls: "mean"},
        {p: "/cb/pools/172.23.96.67:11210/p99", red: "avg", "lbl": "172.23.96.67:11210 pool p99", cls: "p99"},
...
*/
        ...
        {p: "/cb/ops/GetsRaw/count", red: "c_avg", "lbl": "172.23.96.62:11210 GetsRaw count", cls: "count"},
        {p: "/cb/ops/GetsRaw/max", red: "avg", "lbl": "172.23.96.62:11210 GetsRaw max", cls: "max"},
        {p: "/cb/ops/GetsRaw/mean", red: "avg", "lbl": "172.23.96.62:11210 GetsRaw mean", cls: "mean"},
        {p: "/cb/ops/GetsRaw/p99", red: "avg", "lbl": "172.23.96.62:11210 GetsRaw p99", cls: "p99"},

        {p: "/cb/ops/casNext/count", red: "c_avg", "lbl": "172.23.96.67:11210 casNext count", cls: "count"},
        {p: "/cb/ops/casNext/max", red: "avg", "lbl": "172.23.96.67:11210 casNext max", cls: "max"},
        {p: "/cb/ops/casNext/mean", red: "avg", "lbl": "172.23.96.67:11210 casNext mean", cls: "mean"},
        {p: "/cb/ops/casNext/p99", red: "avg", "lbl": "172.23.96.67:11210 casNext p99", cls: "p99"},

/*
        {p: "/cb/ops/Write(raw)/count", red: "c_avg", "lbl": "172.23.96.67:11210 Write(raw) count", cls: "count"},
        {p: "/cb/ops/Write(raw)/max", red: "avg", "lbl": "172.23.96.67:11210 Write(raw) max", cls: "max"},
        {p: "/cb/ops/Write(raw)/mean", red: "avg", "lbl": "172.23.96.67:11210 Write(raw) mean", cls: "mean"},
        {p: "/cb/ops/Write(raw)/p99", red: "avg", "lbl": "172.23.96.67:11210 Write(raw) p99", cls: "p99"},

        {p: "/cb/ops/Write(0x0)/count", red: "c_avg", "lbl": "172.23.96.67:11210 Write(0x0) count", cls: "count"},
        {p: "/cb/ops/Write(0x0)/max", red: "avg", "lbl": "172.23.96.67:11210 Write(0x0) max", cls: "max"},
        {p: "/cb/ops/Write(0x0)/mean", red: "avg", "lbl": "172.23.96.67:11210 Write(0x0) mean", cls: "mean"},
        {p: "/cb/ops/Write(0x0)/p99", red: "avg", "lbl": "172.23.96.67:11210 Write(0x0) p99", cls: "p99"},

        {p: "/cb/ops/Write(0x11)/count", red: "c_avg", "lbl": "172.23.96.67:11210 Write(0x11) count", cls: "count"},
        {p: "/cb/ops/Write(0x11)/max", red: "avg", "lbl": "172.23.96.67:11210 Write(0x11) max", cls: "max"},
        {p: "/cb/ops/Write(0x11)/mean", red: "avg", "lbl": "172.23.96.67:11210 Write(0x11) mean", cls: "mean"},
        {p: "/cb/ops/Write(0x11)/p99", red: "avg", "lbl": "172.23.96.67:11210 Write(0x11) p99", cls: "p99"},

        {p: "/cb/ops/Write(0x3)/count", red: "c_avg", "lbl": "172.23.96.67:11210 Write(0x3) count", cls: "count"},
        {p: "/cb/ops/Write(0x3)/max", red: "avg", "lbl": "172.23.96.67:11210 Write(0x3) max", cls: "max"},
        {p: "/cb/ops/Write(0x3)/mean", red: "avg", "lbl": "172.23.96.67:11210 Write(0x3) mean", cls: "mean"},
        {p: "/cb/ops/Write(0x3)/p99", red: "avg", "lbl": "172.23.96.67:11210 Write(0x3) p99", cls: "p99"},
*/
